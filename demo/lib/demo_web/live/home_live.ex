defmodule DemoWeb.HomeLive do
  ...
  def apply_action(socket, :recipes) do
    assign(socket, :page_title, "Shino.Notification — Recipes")
  end

  def apply_action(socket, :customization) do
    assign(socket, :page_title, "Shino.Notification — Customization")
  end

  def apply_action(socket, _) do
    assign(socket, :page_title, "Shino.Notification — Getting Started")
  end
end
